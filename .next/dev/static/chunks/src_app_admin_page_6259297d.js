        ...
        "AdminDashboard.useEffect": ()=>{
            const fetchStats = {
                "AdminDashboard.useEffect.fetchStats": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/admin/stats');
                        setStats(res.data);
                        setLoading(false);
                    } catch (e) {
...
_s(AdminDashboard, "yM6iCiC8Q/Ws0xfD+5lhrf884v4=");
_c = AdminDashboard;
var _c;
